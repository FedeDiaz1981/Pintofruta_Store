...
export function SiteFooter() {
  return (
    <footer className="mt-16 border-t border-[var(--pf-border-warm)] bg-[linear-gradient(180deg,var(--pf-primary-darker),var(--pf-primary-dark))] text-[#f8f1e7]">
      <div className="pf-shell grid gap-8 px-4 py-10 sm:px-6 lg:grid-cols-[1.4fr_1fr_1fr] lg:px-12">
        <div>
        ...
        <div>
          <h3 className="mb-3 text-sm font-bold uppercase tracking-[0.28em] text-[#f8f1e7]/70">Stack</h3>
          <ul className="space-y-2 text-sm text-[#f8f1e7]/80">
            <li>Next.js + TypeScript</li>
            <li>Tailwind CSS + DaisyUI</li>
            <li>Separación dominio / datos / UI</li>
          </ul>
        </div>
      </div>
    </footer>
